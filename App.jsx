...
const quizData = {
  ...
  i_adjective: [
    ...
    { word: '小さい', reading: 'ちいさい', korean: '작다', conjugations: { present: '小さいです', negative: '小さくありません', negative_alt: '小さくないです', past: '小さかったです', pastNegative: '小さくありませんでした', pastNegative_alt: '小さくなかったです' } },
  ...
  na_adjective: [
    ...
    { word: '不便', reading: 'ふべん', korean: '불편하다', conjugations: { present: '不便です', negative: '不便じゃありません', negative_alt: '不便じゃないです', past: '不便でした', pastNegative: '不便じゃありませんでした', pastNegative_alt: '不便じゃなかったです' } },
  ...
  verb: [
    ...
    { word: '起きる', reading: 'おきる', korean: '일어나다', conjugations: { present: '起きます', negative: '起きません', past: '起きました', pastNegative: '起きませんでした' } },
